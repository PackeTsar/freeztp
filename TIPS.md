...
-----------------------------------------
## TABLE OF CONTENTS
1. [Use-case: Provisioning without using Vlan1](#provisioning-without-using-vlan1)
2. [Use-case: Upgrade IOS-XE 3.7.x to 16.3.6](#upgrade-ios-xe-3.7.x-to-16.3.6)


-----------------------------------------
## Provisioning without using Vlan1
...
-----------------------------------------
## Upgrade IOS-XE 3.7.x to 16.3.6
